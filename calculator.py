...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=11,height=4,text='(',relief='flat',bg='light green',command=lambda:self.show('(')).place(x=0 ,y=50 )
        Button(width=11,height=4,text=')',relief='flat',bg='light green',command=lambda:self.show(')')).place(x=90,y=50 )
        Button(width=11,height=4,text='%',relief='flat',bg='light green',command=lambda:self.show('%')).place(x=180 ,y=50 )
        ...
        Button(width=11,height=4,text='8',relief='flat',bg='pink',command=lambda:self.show(8)).place(x=90 ,y=275 )
        Button(width=11,height=4,text='9',relief='flat',bg='pink',command=lambda:self.show(9)).place(x=180 ,y= 275)
        Button(width=11,height=4,text='0',relief='flat',bg='pink',command=lambda:self.show(0)).place(x=90 ,y=350 )
        Button(width=11,height=4,text='.',relief='flat',bg='pink',command=lambda:self.show('.')).place(x=180 ,y=350 )
        Button(width=11,height=4,text='+',relief='flat',bg='light green',command=lambda:self.show('+')).place(x= 270,y=275  )
        Button(width=11,height=4,text='-',relief='flat',bg='light green',command=lambda:self.show('-')).place(x=270 ,y= 200)
        Button(width=11,height=4,text='/',relief='flat',bg='light green',command=lambda:self.show('/')).place(x=270 ,y= 50)
        Button(width=11,height=4,text='x',relief='flat',bg='light green',command=lambda:self.show('*')).place(x= 270,y=125 )
